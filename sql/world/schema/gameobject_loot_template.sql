-- gameobject_loot_template — structure
--
...
--
-- Applied before data/gameobject_loot_template.sql. Regenerate both with tools/db/export-world.sh.
--
-- Needed by: chest loot — 38,481 of 38,594 spawned chests are locked and now openable.
