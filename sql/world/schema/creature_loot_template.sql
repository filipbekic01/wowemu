-- creature_loot_template — structure
--
...
--
-- Applied before data/creature_loot_template.sql. Regenerate both with tools/db/export-world.sh.
--
-- Needed by: Phase 10 loot — what a creature drops.
