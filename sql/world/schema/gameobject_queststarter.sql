-- gameobject_queststarter — structure
--
...
--
-- Applied before data/gameobject_queststarter.sql. Regenerate both with tools/db/export-world.sh.
--
-- Needed by: quests that start at an object rather than an NPC.
