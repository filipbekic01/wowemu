...
--
-- Applied before data/item_template.sql. Regenerate both with tools/db/export-world.sh.
--
-- Needed by: Phase 4.2 items and inventory — every item the player can hold.
