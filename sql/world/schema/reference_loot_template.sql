-- reference_loot_template — structure
--
...
--
-- Applied before data/reference_loot_template.sql. Regenerate both with tools/db/export-world.sh.
--
-- Needed by: Phase 10 loot — shared drop lists other templates point at.
